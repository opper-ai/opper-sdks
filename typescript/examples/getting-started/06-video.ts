...
console.log("Generating video (schema-driven) — this can take up to a couple of minutes...");
...
console.log("\nGenerating video (convenience) — this can take up to a couple of minutes...");
